...
from parkhaus.config.config import app_config, resources_path
...
_dbname: Final[str] = _db_toml.get("name", "parkhaus")
_host: Final[str] = _db_toml.get("host", "postgres")
_username: Final[str] = _db_toml.get("username", "parkhaus")
