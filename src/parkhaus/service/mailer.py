...
def send_mail(parkhaus_dto: ParkhausDTO) -> None:
    """Funktion, um eine E-Mail zu senden.

    :param parkhaus_dto: Parkhaus-Daten
    """
    ...
    # Body und Subject
    msg: Final = MIMEText(f"Neues Parkhaus: <b>{parkhaus_dto.name}</b>")
    msg["Subject"] = f"Neues Parkhaus: ID={parkhaus_dto.id}"
