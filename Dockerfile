...
# Aufruf:   docker build --tag juergenzimmermann/parkhaus:2026.4.1-hardened .
#               ggf. --no-cache
#
...
#
#           docker debug juergenzimmermann/parkhaus:2026.4.1-hardened
#           docker scout sbom juergenzimmermann/parkhaus:2026.4.1-hardened
#           docker scout cves juergenzimmermann/parkhaus:2026.4.1-hardened
#           docker save juergenzimmermann/parkhaus:2026.4.1-hardened > parkhaus.tar
